...
public class RecordImpl implements Record {
    ...
    public String getValue(String attribute) {
        ...
        throw new IllegalStateException("Tha attribute " + attribute + " doesn't have a paired string.");
    }
    ...
    public String[] getValues(String attribute) {
        ...
        throw new IllegalStateException("Tha attribute " + attribute + " doesn't have a paired string array.");
    }
