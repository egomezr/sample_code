...
public class DynamiCloudUtil {
     ...
     */
    protected static RecordResults buildRecordResults(ServiceResponse response, Class boundClass) {
     ...
     */
    private static List<Object> getRecordList(JSONObject data, Class boundClass)
    ...
    /**
     * This method will extract data and return and list of records
     *
     * @param data json with all data from DynamiCloud servers
     * @return list of records
     */
     ...
     */
    protected static String buildFieldsJSON(BoundInstance instance) {
    ...
    public static String buildString(List<Condition> conditions, GroupByClause groupBy, OrderByClause orderBy,
                                     String projection) throws DynamiCloudSessionException {
